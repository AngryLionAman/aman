...
public final class createUserName_jsp extends org.apache.jasper.runtime.HttpJspBase
    ...
    try {
      ...
      out.write("        ");
        ...
        try{
            ...
            rs = ps.executeQuery();
            while(rs.next()){
                String fullname  = rs.getString("firstname").trim();
                String email = rs.getString("email");
                String sql_update = "update newuser set username = ? where email = ?";
                ps1 = con.prepareStatement(sql_update);
